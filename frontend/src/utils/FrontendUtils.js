...
export const PLACEHOLDER_BIO = 'Enter biography here';

// Related to Input validation modal
export const ERROR_MODAL_TITLE = "Invalid Input";
export const ERROR_AUTHOR_NAME = "Author name should not be empty and should not have more than 45 characters";
export const ERROR_AUTHOR_BIO = "Author biography should not be empty and should not have more than 200 characters";
